...
export function jsx(tagName, attributes) {
...
self.jsx = jsx;
function walkChildren(children, node, childNodes) {
 ...
 */
function normalizeClassAttribute(node) {
...
function initializeDirectives(node) {
